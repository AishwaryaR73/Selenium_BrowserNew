...
import nopUtility.ExcelUtils;

public class AddCussExcel extends BaseTest {
	// creating object of ExcelUtils class
	static ExcelUtils excelUtils = new ExcelUtils();
	static String excelFilePath = Constants.TestData_Path + Constants.File_TestData;
...
//			Thread.sleep(3000);
			...
			WebElement confirmationMessage=driver.findElement(By.xpath("//li[contains(text(),'Email is already registered')]"));
			
			//WebElement confirmationMessage = driver.findElement(By.xpath("//div[@class='content-wrapper']//div"));
